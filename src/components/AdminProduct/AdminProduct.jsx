...
const AdminProduct = () => {
    ...
    const renderAction = () => {
        return (
            <div>
                <DeleteOutlined style={{ color: 'red', fontSize: '24px', cursor: 'pointer'}} onClick={() => setIsModalOpenDelete(true)} />
                <EditOutlined style={{ color: 'orange', fontSize: '24px', cursor: 'pointer' }} onClick={handleDetailsProduct} />
            </div>
        );
    };
